...
class MemoryBoardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.mamory_card, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if (memoryCard.isFaceUp) {
                ...
                imageButton.setImageResource(R.drawable.water)
            }

            imageButton.alpha = if(memoryCard.isMatched) .4f
            else 1.0f

            val colorStateList = if (memoryCard.isMatched) ContextCompat.getColorStateList(context, R.color.color_gray)
            else null
