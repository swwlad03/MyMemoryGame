...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 136
        private const val READ_EXTERNAL_PHOTO_CODE = 150
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvImagePicker.findViewById<RecyclerView>(R.id.rvImagePicker)
        etGameName.findViewById<EditText>(R.id.etGameName)
        btnSave.findViewById<Button>(R.id.btnSave)
        pbUploading.findViewById<ProgressBar>(R.id.pbUploading)
            ...
            object : ImagePickerAdapter.ImageClickListener {
                override fun onPlaceHolderClicked() {
                    if (isPermissionGranted(this@CreateActivity, READ_PHOTOS_PERMISSION)) {
                        ...
                        requestPermission(
                            this@CreateActivity,
                            READ_PHOTOS_PERMISSION, READ_EXTERNAL_PHOTO_CODE
                        )
                    }
                }
            })
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_EXTERNAL_PHOTO_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(
                    this,
                    "In order to crate a custom game, you need to provide access to your photos",
                    Toast.LENGTH_LONG
                ).show()
            }
        }
    ...
    private fun launchIntentForPhotos() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Choose picks"), PICK_PHOTO_CODE)
    }
}